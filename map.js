...
const map = new mapboxgl.Map({
  ...
  style: "mapbox://styles/bethtes/cl9wty6hi000914mj0tzen6yo", // Map style to use
...
const popup = new mapboxgl.Popup({
  ...
  const submitForm = (location) => {
    ...
    // longitude
    submission[7] = newPoint.geometry.coordinate[0];
    // description
